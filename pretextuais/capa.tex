...
\titulo{\uppercase{Aplicação de Redes Neurais Convolucionais para Detecção de Anomalias Visuais em Jogos Digitais}}
\autor{\uppercase{MATHEUS ALVES BUENO MACHADO}}
\local{Videira}
\data{2025}
\orientador[Orientador:]{Rafael Antonio Zanin}
